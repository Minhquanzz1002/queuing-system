    ...
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="vuesax/linear/monitor">
            <g id="monitor">
                ...
                <path id="Vector_2" d="M10 14.3496V18.3329" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"
...
const MonitorIcon = (props: Partial<ICustomIconProps>) => <Icon {...props} component={MonitorSvg}/>;
